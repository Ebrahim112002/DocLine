...
import { 
  ...
  HeartPulse, Info, PhoneCall 
} from 'lucide-react';
import { NavLink } from 'react-router';

// Framer Motion এর সাথে NavLink কে কম্বাইন করা হলো যাতে অ্যানিমেশন ও রাউটিং একসাথে কাজ করে
...
const Navbar = () => {
  ...
  // মোশন অ্যানিমেশনের ভেরিয়েন্ট (Variants)
        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <div className="hidden lg:flex items-center justify-center gap-6 xl:gap-8 flex-1">
            ...
            <MotionNavLink 
              ...
              to="/" 
              className={({ isActive }) => 
                `flex items-center gap-2 font-medium text-[15px] transition-colors group whitespace-nowrap ${
            ...
            >
              {({ isActive }) => (
                <>
                  <Home className={`w-4 h-4 transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'}`} />
                  <span>হোম</span>
                </>
              )}
            </MotionNavLink>
              ...
              <div className="absolute top-full left-0 mt-1 pt-2 w-60 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-200 z-50">
                ...
                >
                  <MotionNavLink 
                    whileHover={{ x: 4 }} 
                    to="/doctors" 
                    className={({ isActive }) => `flex items-center gap-3 p-3 rounded-xl transition-colors ${isActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50/60 hover:text-blue-600'}`}
                  >
            ...
            >
              {({ isActive }) => (
                <>
                  <Calendar className={`w-4 h-4 transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <HeartPulse className={`w-4 h-4 transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <Info className={`w-4 h-4 transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'}`} />
            ...
            >
              {({ isActive }) => (
                <>
                  <PhoneCall className={`w-4 h-4 transition-colors ${isActive ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600'}`} />
                  <span>যোগাযোগ</span>
                </>
              )}
            </MotionNavLink>
          ...
          <div className="flex items-center gap-2 xl:gap-3 flex-shrink-0">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.97 }}
              className="hidden md:flex items-center gap-2 px-5 py-3 text-gray-700 hover:bg-gray-100 rounded-2xl font-medium whitespace-nowrap"
            >
            ...
            {/* Register */}
            <motion.button 
              whileHover={{ scale: 1.03, boxShadow: "0px 10px 20px rgba(37, 99, 235, 0.2)" }}
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-2xl font-semibold whitespace-nowrap"
            >
            ...
            <motion.button
              ...
              className="lg:hidden p-3 hover:bg-gray-100 rounded-2xl text-gray-600"
            >
            ...
            <div className="px-6 pt-4 pb-8 space-y-1">
              {[
                ...
                <MotionNavLink 
                  ...
                  to={item.href} 
                  className={({ isActive }) => 
                    `flex items-center gap-4 px-5 py-4 text-lg rounded-2xl transition-colors ${
                      isActive ? 'bg-blue-50 text-blue-600' : 'text-gray-800 hover:bg-blue-50/50'
                    }`
                  }
